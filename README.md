...
- **Visualization**: Bubble plot balancing demand and salary, with skill categories.  
  ![Optimal Skills Bubble](visualizations/optimal_skills_bubble.png)
...
- **Top-Paying Skills**: Bar chart of skills with highest average salaries.  
  ![Top Paying Skills](visualizations/top_paying_skills.png)
- **Optimal Skills**: Bubble plot showing demand vs. salary, with skills categorized by type.  
  ![Optimal Skills Bubble](visualizations/optimal_skills_bubble.png)
